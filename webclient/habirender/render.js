...
// The C64 palette, the 4×4 dither patterns and rgbaFromNibble now live in ./palette.js — pure, no
// preact, so node-side code (render3d/habimat.js and its test) can reach them. Re-exported here
// because every existing importer expects them from render.js.
// Imported as well as re-exported: `export … from` forwards the names without binding them in this
// module's scope, and canvasFromBitmap / bitmapForText below use defaultColors and rgbaFromNibble
// directly.
import { c64Colors, celPatterns, defaultColors, rgbaFromNibble } from "./palette.js"
export { c64Colors, celPatterns, defaultColors, rgbaFromNibble }
