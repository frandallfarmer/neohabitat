 ...
 * 
 * Your Avatar walks on the Ground. Only responds to HELP messages.
 * [The client is supposed to be smart and transform interface commands
 * to *other* objects (usually the Region) as needed.]
 * 
 * @author randy
 *
 */
...
public class Ground extends Walkable {
	...
	public int		HabitatClass 	 () { return CLASS_GROUND; }
	public String	HabitatModName	 () { return "Ground"; }
	...
	public Ground(OptInteger style, OptInteger x, OptInteger y,
			OptInteger orientation, OptInteger gr_state, OptInteger flat_type) {
