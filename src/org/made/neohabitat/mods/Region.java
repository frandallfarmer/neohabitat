 ...
 * of Habitat. It is the "room" logic, controlling how things interact
 * with each other - not on a Item to Item or User to User basis, but
 * when interacting between multiple objects in the region. 
 *
...
public class Region extends Container implements ContextMod, Constants {
	...
	public static final int DEFAULT_REGION_DEPTH = 32;	// TODO What is the correct default region depth?

	public int		HabitatClass 	 () { return CLASS_REGION; }
	public String	HabitatModName	 () { return "Region"; }
	public int		capacity 		 () { return 255; }
	...
	/** This is an array holding all the Mods for all the Users and Items in this room.*/	//TODO Abstract this away! FRF */
	...
	Region(OptInteger style, OptInteger x, OptInteger y, OptInteger orientation, 
			OptInteger gr_state, OptInteger nitty_bits,
			OptInteger depth, OptInteger lighting, String[] neighbors) {
	 ...
	 * 
	 * @param from The client disconnecting
	 */
	@JSONMethod ({"reason"})
	 ...
	 * react. The server is told by this message that it deal with messages before this as being before the
	 * user has appeared.
	 * 
	 * @param from The client connection that needs to catch up...
	 */
	@JSONMethod
	 ...
	 * 
	 * @param from The client connection that has "caught up" loading the contents vector it just received.
	 */
	@JSONMethod
	...
	/**
	 * Handle a prompted message, overloading the text-entry field. This requires some callback related storage in Avatar.
	 * 
	 * @param from The user-connection that sent the prompt reply
	 * @param text The prompt reply (includes any prompt.)
	 */
	@JSONMethod ({"text"})
