...
public class Bag extends Openable {
	...
	public int		HabitatClass 	 () { return CLASS_BAG; }
	public String	HabitatModName	 () { return "Bag"; }
	...
	public Bag(OptInteger style, OptInteger x, OptInteger y, 
	 ...
	 */
	@JSONMethod
	public void HELP (User from)	{ bag_HELP(from); }
