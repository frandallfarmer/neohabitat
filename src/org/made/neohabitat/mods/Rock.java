 ...
 * 
 * Rock don't really do much. Responds to HELP messages.
 * It *may* be portable based on how Massive it is. Otherwise
 * the client is supposed to be smart and transform interface commands
 * to *other* objects as needed.
 * 
 * @author randy
 *
 */
public class Rock extends Massive {
	...
	public int		HabitatClass 	 () { return CLASS_ROCK; }
	public String	HabitatModName	 () { return "Rock"; }
	...
	public Rock (OptInteger style, OptInteger x, OptInteger y, 
