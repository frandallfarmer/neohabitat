 ...
 * 
 * Trees don't really do much. Only responds to HELP messages.
...
public class Tree extends HabitatMod {
	...
	public int		HabitatClass 	 () { return CLASS_TREE; }
	public String	HabitatModName	 () { return "Tree"; }
	...
	public Tree(OptInteger style, OptInteger x, OptInteger y,
