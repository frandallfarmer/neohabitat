...
public class Flashlight extends Switch {
	...
	public int		HabitatClass 	 () { return CLASS_FLASHLIGHT; }
	public String	HabitatModName	 () { return "Flashlight"; }
	...
	public Flashlight(OptInteger style, OptInteger x, OptInteger y, 
			OptInteger orientation, OptInteger gr_state, OptInteger on) {
	 ...
	 */
	@JSONMethod
	public void HELP (User from)	{ flashlight_HELP(from); }
	 ...
	 */
	@JSONMethod
	public void OFF (User from)	{ generic_OFF(from); }
	 ...
	 */
	@JSONMethod
	public void ON (User from)	{ generic_ON(from); }
