 ...
 * 
 * Though the switch is attached specifically to items that effect lighting, it is not a requirement.
 */
public abstract class Switch extends HabitatMod {

	/** On-off state. Set using the integer constants: TRUE/FALSE *not* the boolean: true/false */
